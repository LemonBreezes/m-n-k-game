...
class BoardTests(unittest.TestCase):
    ...
    def test_get_player_score(self):
        ...
        self.assertEqual(board.board, [[1, 0, 0], [1, 0, 0], [1, 0, 0]])
        ...
        self.assertEqual(board.board, [[1, 0, 1], [0, 1, 0], [0, 0, 0]])
        ...
        self.assertEqual(board.board, [[1, 2, 1], [2, 1, 2], [2, 1, 2]])
        ...
        self.assertEqual(board.board, [[1, 1, 0], [1, 0, 1], [0, 1, 1]])
        self.assertEqual(board.get_player_score(1), 2)
        self.assertEqual(board.has_no_blanks(), False)
        board.add_mark(1, 1, 1)
        self.assertEqual(board.board, [[1, 1, 0], [1, 1, 1], [0, 1, 1]])
        self.assertEqual(board.get_player_score(1), 3)
        self.assertEqual(board.has_no_blanks(), False)
